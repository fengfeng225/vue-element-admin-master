        ...
        <el-tabs>
          <el-tab-pane label="登录账户设置">
            ...
            <el-form ref="userForm" :model="userInfo" :rules="rules" label-width="120px" style="margin-left: 120px; margin-top:30px">
              ...
              <el-form-item>
                <el-button size="small" type="primary" @click="saveUser">更新</el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        password2: [{ required: true, message: '密码不能为空', trigger: 'blur' }, { min: 6, max: 9, message: '密码长度为6-9位', trigger: 'blur' }]
      }
    }
  },
  created() {
