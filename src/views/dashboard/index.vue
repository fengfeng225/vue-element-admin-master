<template>
  <div class="dashboard-container">
    ...
    <el-dialog :visible="showDialog" title="我的申请" @close="btnCancel">
      <el-form ref="form" label-width="120px" :model="ruleForm" :rules="rules">
        <el-form-item label="申请类型">
          <el-select v-model="ruleForm.processKey">
            <el-option label="离职" value="process_dimission" />
            <el-option label="加班" value="process_add" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="理由" prop="reason">
          <el-input v-model="ruleForm.reason" type="textarea" :rows="3" style="width: 300px;" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import WorkCalendar from '@/views/dashboard/component/work-calendar'
import Radar from '@/views/dashboard/component/radar'
